...
import com.example.rfid_scanner.module.main.explore.property.ExplorePropertyViewModel.Companion.KEY_PROPERTY_UNIT
...
class ExplorePropertyFragment : BaseFragment<FragmentExploreBinding, ExplorePropertyViewModel>() {
    ...
    override fun setUpViews() = with(binding) {
        ...
        fabAdd.setOnClickListener {
            navigateTo(
                ExplorePropertyFragmentDirections.actionExplorePropertyFragmentToAlterPropertyFragment(
                    viewModel.type,
                    null
                )
            )
