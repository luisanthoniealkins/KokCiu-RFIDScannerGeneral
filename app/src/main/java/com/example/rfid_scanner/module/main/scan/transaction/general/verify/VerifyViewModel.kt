...
import com.example.rfid_scanner.module.main.scan.transaction.general.verify.adapter.VerifyTagAdapter.VerifyTagData
...
class VerifyViewModel : BaseViewModel() {
    ...
    fun setAdapter(verifyTags: List<Tag>) {
        ...
        verifyTagAdapter = VerifyTagAdapter(verifyTags.map { VerifyTagData(it, false) })
