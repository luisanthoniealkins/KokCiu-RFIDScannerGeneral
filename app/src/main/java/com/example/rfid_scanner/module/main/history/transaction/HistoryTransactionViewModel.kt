...
class HistoryTransactionViewModel : BaseViewModel(), ItemClickListener {
    ...
    private val _lvSelectedItem = MutableLiveData<HandledEvent<String>>()
    val lvSelectedItem : LiveData<HandledEvent<String>> = _lvSelectedItem
    ...
    override fun onItemClick(item: Any) {
        _lvSelectedItem.postValue(HandledEvent(item as String))
    }
}