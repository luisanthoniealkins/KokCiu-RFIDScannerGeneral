...
class VerifyBottomSheet(private val listener: VerifyInterface, private val verifyTags: List<Tag>) :
    ...
    private fun setUpViews() = with(binding){
        ...
        btnConfirm.setOnClickListener {
            if (viewModel.errorAdapter.getError() == null && viewModel.verifyTagAdapter.isAllVerified()) {
                listener.onBottomSheetDismiss(true)
    ...
    override fun onCancel(dialog: DialogInterface) {
        ...
        listener.onBottomSheetDismiss(false)
    }
